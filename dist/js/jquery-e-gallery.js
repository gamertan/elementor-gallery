...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/jquery-e-gallery.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _e_gallery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./e-gallery */ "./src/js/e-gallery.js");
...
$.fn.eGallery = function (settings) {
  ...
  this.each(function (index) {
    ...
    if (!isCommand) {
      ...
      $this.data('eGallery', new _e_gallery__WEBPACK_IMPORTED_MODULE_0__["default"](settings));
      return;
    }

    var instance = $this.data('eGallery');
    ...
    instance[settings].apply(instance, [instance].concat(args));
...
/******/ });
//# sourceMappingURL=jquery-e-gallery.js.map